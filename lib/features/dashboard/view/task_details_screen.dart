...
import 'package:razinsoft_task_management/core/utils/toast_helper.dart';
...
class TaskDetailsScreen extends StatefulWidget {
  ...
  @override
  State<TaskPage> createState() => _TaskDetailsScreenState();
}

class _TaskDetailsScreenState extends State<TaskPage> {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ToastHelper.successToastMessage('Task created');
                        },
                        child: Text(
                          'Create new tasks',
                          style: Theme.of(context).textTheme.titleMedium?.copyWith(
